...
public class InvalidGcmRequestExceptionTest {

  @Test
  public void testGetters_noDescription() {
    InvalidGcmRequestException exception = new InvalidGcmRequestException(401);
  ...
  public void testGetters_description() {
    InvalidGcmRequestException exception =
        new InvalidGcmRequestException(401, "D'OH!");
    assertEquals(401, exception.getHttpStatusCode());
