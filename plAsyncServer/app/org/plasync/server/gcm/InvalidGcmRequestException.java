 ...
 */
public final class InvalidGcmRequestException extends IOException {

    private final int status;
    private final String description;

    public InvalidGcmRequestException(int status) {
        this(status, null);
    }

    public InvalidGcmRequestException(int status, String description) {
